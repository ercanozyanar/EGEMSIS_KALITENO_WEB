...
namespace Uretim_Kalite.Controllers
{
    public class GravurController : Controller
    {
                ...
                try
                {
                    ...
                    for (int i = 0; i < files.Count; i++)
                    {
                        ...
                        else
                        {
                            ...
                            fname = Path.Combine(("~/Content/NOK_IMAJ/GRAVUR/"), dosyaadi + "_" + fileName);
                            file.SaveAs(fname);
                            adi = dosyaadi;
                        }
                    }
        ...
        public ActionResult GravurNOK(String Search_Data, String Filter_Value, int? Page_No)
        {
            ...
            var students = from stu in db.EGEM_GRAVUR_KALITENOKIMAJ select stu;
            if (!String.IsNullOrEmpty(Search_Data))
            {
